...
![Angular](https://img.shields.io/badge/angular-%2320232a.svg?style=for-the-badge&logo=angular)  ![TailwindCSS](https://img.shields.io/badge/tailwindcss-%2338B2AC.svg?style=for-the-badge&logo=tailwind-css&logoColor=white)
...
The app is built with `angular`,`vite` and uses `tailwindcss` for the UI components.
...
```bash
git clone https://github.com/getvim/vim-canvas-demo-angular.git
```

2. Navigate to the project directory:

```bash
cd vim-canvas-demo-app-angular
```
